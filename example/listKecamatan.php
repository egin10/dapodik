 ...
 * url : https://referensi.data.kemdikbud.go.id/index11.php?kode=KODE_KABUPATEN&level=2
 */

$getData = new GetData;
$url = "https://referensi.data.kemdikbud.go.id/index11.php?kode=166000&level=2";
$ch = curl_init($url);
